...
- [ ] 2.1 先寫 `tests/contract/rest/enter.contract.ts`：`[FE-N08-S12]` 的矩陣（401、404、404、403、200、closed 有密碼 200；名片已刪那列是已知差異，不進矩陣）；另寫 `tests/server-enter.test.ts`：`[FE-N08-S16]`（node、假 db：名片查不到 → 401、沒有第二道 SQL）、座位空與滿都 200、票對替身握手（同房同人收、別房拒、別人的 cookie 拒）、`[FE-N08-S13]` 兩個目標同一份 —— 對 `local` 目標先紅
