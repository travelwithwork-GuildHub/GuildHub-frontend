...
| FE-B08 | 發現入口 | Marketplace 看板、Guild Hall 的熱門／缺人、分享的連結直接進 | W6 | 4 | | Later｜demo 之後（2026-09-19）：demo 範圍外的純前端功能，demo 後重排 |
...
| FE-N07 | 房間權限 | 接受 Offer 後自動取得 Project Room 存取，不用再輸一次密碼 | W9 | 5 | | Later｜demo 之後（2026-09-19）：demo 範圍外的純前端功能，demo 後重排 |
