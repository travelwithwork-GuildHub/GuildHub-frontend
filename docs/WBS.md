...
| **M3** Guild Hall 成形 | W3 | 統一風格的世界、Presence、場景 chat、狀態文字 | FE-W08、FE-W09、FE-W10、FE-W11、FE-W12、FE-W19、FE-R10、FE-R11、FE-K04、FE-K05、FE-X11 |
...
| **M9** 從有意願走到成軍 | W9 | 洽談對話串、條件修訂、Offer 與失敗路徑、雙方確認、房間權限 | FE-N01、FE-N02、FE-N03、FE-N04、FE-N05、FE-N06、FE-N07、FE-N08 |
